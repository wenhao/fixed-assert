    ...
    return (
      <Paper zDepth={1} className="page-auth">
        <div className="login-group">
          <h3>Log in</h3>
          <div>
            <TextField ref="username" hintText="User name" floatingLabelText="User name"/>
          </div>
          <div>
            <TextField ref="password" type="password" hintText="Password" floatingLabelText="Password"/>
          </div>
